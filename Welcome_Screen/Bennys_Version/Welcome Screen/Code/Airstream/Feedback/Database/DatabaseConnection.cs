...
namespace Airstream.Feedback.Database
{
    public class DatabaseConnection
    {
        ...
        public List<string>[] SelectFromUsers(string rfidNumber)
        {
            ...
            string query = String.Format("SELECT {0} FROM rfid_storage WHERE rfid_number = '{1}';", string.Join(",", columnNames), rfidNumber);
