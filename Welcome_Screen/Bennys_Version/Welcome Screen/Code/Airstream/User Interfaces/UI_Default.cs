...
namespace Airstream.User_Interfaces
{
    public partial class UI_Default : Form
    {
        ...
        private TextBox _rfidTriggerTextBox;
        

        public static void setRfidScanImage(string imageName)
        {
            if(imageName != "rfid_scan.png" && imageName != "rfid_recognized.png")
            {
                return;
            }

            _rfidScanImage.BackgroundImage = new Bitmap(projectFolder + @"Pictures\" + imageName);
        }
        ...
        public static void SetUniqueElements()
        {
            ...
            _rfidScanImage.Size = new Size(500, 100);
            _rfidScanImage.Location = new Point(Convert.ToInt32(UI_General.GetSizeScreen().Width * 0.5 - (_rfidScanImage.Size.Width / 2)), Convert.ToInt32(UI_General.GetSizeScreen().Height * 0.85));
            _rfidScanImage.BackgroundImage = new Bitmap(projectFolder + @"Pictures\rfid_scan.png");
        ...
        private void _rfidScanned(object sender, EventArgs e)
        {
            if (_rfidTriggerTextBox.Text.Length == 8)
            {
                ...
                UI_Default.setRfidScanImage("rfid_recognized.png");
